...
class ComplainsControllerTest < ActionController::TestCase
  ...
  test "should create complain" do
    assert_difference('Complain.count') do
      post :create, complain: { description: @complain.description, ip_address: @complain.ip_address, latitude: @complain.latitude, location: @complain.location, longitude: @complain.longitude, title: @complain.title, user_id: @complain.user_id }
    end
  ...
  test "should update complain" do
    patch :update, id: @complain, complain: { description: @complain.description, ip_address: @complain.ip_address, latitude: @complain.latitude, location: @complain.location, longitude: @complain.longitude, title: @complain.title, user_id: @complain.user_id }
    assert_redirected_to complain_path(assigns(:complain))
  end
