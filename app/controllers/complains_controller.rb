class ComplainsController < ApplicationController
  ...
  def create
    ...
    #@complain.ip_address = Rails.env.development? ? '74.125.236.201' : request.remote_ip
    @complain.ip_address = Rails.env.development? ? '103.250.69.218' : request.remote_ip
  ...
  private
    ...
    def complain_params
      params.require(:complain).permit(:title, :description, :longitude, :latitude, :ip_address, :user_id, :location)
    end
end
